...
def read_image_to_cvmat(image_path, height, width, is_gray):
    ...
    cv_img = cv2.imread(image_path.strip(), cv_read_flag)
...
if __name__ == '__main__':
    ...
    parse.add_argument('--resize_height', type=int, default=640, help = 'target height')
    parse.add_argument('--resize_width', type=int, default=640, help = 'target width')
