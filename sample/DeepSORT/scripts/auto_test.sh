...
then
  ...
  then
    ...
    then
      ...
      test_python opencv extractor_fp16_4b.bmodel ../datasets/test_car_person_1080P.mp4
      test_python opencv extractor_int8_1b.bmodel ../datasets/test_car_person_1080P.mp4
      test_python opencv extractor_int8_4b.bmodel ../datasets/test_car_person_1080P.mp4
      test_cpp soc bmcv extractor_fp16_1b.bmodel ../../datasets/test_car_person_1080P.mp4
      test_cpp soc bmcv extractor_fp16_4b.bmodel ../../datasets/test_car_person_1080P.mp4
      test_cpp soc bmcv extractor_int8_1b.bmodel ../../datasets/test_car_person_1080P.mp4
      test_cpp soc bmcv extractor_int8_4b.bmodel ../../datasets/test_car_person_1080P.mp4

      eval_python opencv extractor_fp16_1b.bmodel 0.45078858055500104
      eval_python opencv extractor_fp16_4b.bmodel 0.45078858055500104
      eval_python opencv extractor_int8_1b.bmodel 0.44539828309043716
      eval_python opencv extractor_int8_4b.bmodel 0.44539828309043716
      eval_cpp soc bmcv extractor_fp16_1b.bmodel 0.4479936114993013
      eval_cpp soc bmcv extractor_fp16_4b.bmodel 0.4479936114993013
      eval_cpp soc bmcv extractor_int8_1b.bmodel 0.44739468955879413
      eval_cpp soc bmcv extractor_int8_4b.bmodel 0.44739468955879413
    elif test $CASE_MODE = "partly"
    then
      test_python opencv extractor_int8_4b.bmodel ../datasets/test_car_person_1080P.mp4
      test_cpp soc bmcv extractor_int8_4b.bmodel ../../datasets/test_car_person_1080P.mp4
