...
do
    ...
    model_transform.py \
        ...
        --model_def segmentation_controlnet_${height}_${width}.pt \
        --input_shapes [[2,4,${latent_height},${latent_width}],[1],[2,77,768],[2,3,${height},${width}]] \
        --mlir segmentation_controlnet_${height}_${width}.mlir
    ...
    model_deploy.py \
        ...
        --chip bm1684x \
        --merge_weight \
        --model segmentation_controlnet_${height}_${width}.bmodel
    fi
done

model_tool \
    --combine *.bmodel \
    -o segmentation_controlnet_fp16.bmodel

mv segmentation_controlnet_fp16.bmodel $outdir

popd $script_directory 