...
do
    ...
    model_transform.py \
        ...
        --model_def depth_controlnet_${height}_${width}.pt \
        --input_shapes [[2,4,${latent_height},${latent_width}],[1],[2,77,768],[2,3,${height},${width}]] \
        --mlir depth_controlnet_${height}_${width}.mlir
    ...
    model_deploy.py \
        ...
        --chip bm1684x \
        --merge_weight \
        --model depth_controlnet_${height}_${width}.bmodel
    fi
done

model_tool \
    --combine *.bmodel \
    -o depth_controlnet_fp16.bmodel
