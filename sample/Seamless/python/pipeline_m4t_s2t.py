...
def argsparser():
    ...
    parser.add_argument('--encoder_frontend_bmodel', type=str, default=os.environ.get("SEAMLESS_MODEL_DIR", "../models/BM1684X") + "/m4t_encoder_frontend_fp16_s2t.bmodel", help='path of Wav2Vec2Frontend bmodel')
    parser.add_argument('--encoder_bmodel', type=str, default=os.environ.get("SEAMLESS_MODEL_DIR", "../models/BM1684X") + "/m4t_encoder_fp16_s2t.bmodel", help='path of UnitYEncoderAdaptor bmodel')
    parser.add_argument('--tokenizer_model', type=str, default='../models/tokenizer.model', help='path of tokenizer model')
    parser.add_argument('--decoder_frontend_bmodel', type=str, default=os.environ.get("SEAMLESS_MODEL_DIR", "../models/BM1684X") + "/m4t_decoder_frontend_beam_size_fp16_s2t.bmodel", help='path of text decoder frontend bmodel')
    parser.add_argument('--decoder_bmodel', type=str, default=os.environ.get("SEAMLESS_MODEL_DIR", "../models/BM1684X") + "/m4t_decoder_beam_size_fp16_s2t.bmodel", help='path of text decoder bmodel')
    parser.add_argument('--decoder_final_proj_bmodel', type=str, default=os.environ.get("SEAMLESS_MODEL_DIR", "../models/BM1684X") + "/m4t_decoder_final_proj_beam_size_fp16_s2t.bmodel", help='path of final proj bmodel')
