...
function gen_mlir_image_encoder()
{
    model_transform.py \
        ...
        --model_def ../models/onnx/video/sam2_image_encoder_no_pos.onnx\
...
function gen_mlir_image_decoder()
{
    model_transform.py \
        ...
        --model_def ../models/onnx/video/sam2_image_decoder.onnx \
...
function gen_mlir_memory_attention()
{
    model_transform.py \
        ...
        --model_def ../models/onnx/video/sam2_memory_attention_nomatmul.onnx \
...
function gen_mlir_memory_encoder()
{
    model_transform.py \
        ...
        --model_def ../models/onnx/video/sam2_memory_encoder.onnx \
