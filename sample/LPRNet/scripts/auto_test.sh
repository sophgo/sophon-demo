...
function bmrt_test_benchmark(){
    ...
    if test $TARGET = "BM1684"; then
      ...
      bmrt_test_case CV84X6/lprnet_fp32_1b.bmodel
      bmrt_test_case CV84X6/lprnet_fp16_1b.bmodel
      bmrt_test_case CV84X6/lprnet_int8_1b.bmodel
      bmrt_test_case CV84X6/lprnet_int8_4b.bmodel
    fi
