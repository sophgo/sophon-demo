...
function bmrt_test_benchmark(){
    ...
    if test $TARGET = "BM1684"; then
      ...
      bmrt_test_case BM1684X2/lprnet_fp32_1b.bmodel
      bmrt_test_case BM1684X2/lprnet_fp16_1b.bmodel
      bmrt_test_case BM1684X2/lprnet_int8_1b.bmodel
      bmrt_test_case BM1684X2/lprnet_int8_4b.bmodel
    fi
