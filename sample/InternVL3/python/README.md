...
| 序号  |  Python例程       |            说明                 |
| ---- | ---------------- | ------------------------------ |
|   1  | internvl3_sail.py | 使用SAIL推理的例程 |
...
```bash
usage: internvl3_sail.py [-h] -m MODEL_PATH [-t TOKENIZER] [-d DEVID]

optional arguments:
  -h, --help            show this help message and exit
  -m MODEL_PATH, --model_path MODEL_PATH
                        path to the bmodel file
  -t TOKENIZER, --config_path TOKENIZER
...
```bash
cd python
python3 internvl3_sail.py --model_path internvl3-2b_bm1684x_int4.bmodel --config_path config --devid 0
```
