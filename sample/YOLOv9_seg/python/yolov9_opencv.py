...
def main(args):
    ...
    # warm up
    # for i in range(10):
    #     results = yolov9([np.zeros((640, 640, 3))])
    yolov9.init()
            ...
            for filename in filenames:
                ...
                if (len(img_list) == batch_size or cn == len(filenames)) and len(img_list):
                    ...
                    for i, filename in enumerate(filename_list):
                        ...
                        yolov9.postprocess.draw_and_visualize(save_name,img_list[i], boxes, segments, vis=False, save=True)
                        res_dict = dict()
        ...
        while not end_flag:
            ...
            if (len(frame_list) == batch_size or end_flag) and len(frame_list):
                ...
                for i, frame in enumerate(frame_list):
                    ...
                    res_frame=yolov9.postprocess.draw_and_visualize("save_name",frame_list[i], boxes, segments, vis=False, save=False)
                    out.write(res_frame)
