...
#   - CV84X6_504.zip  : CV84X6(SE13等) FP16 bmodel（同构；该芯片固件不支持 FP32）
...
then
    ...
    python3 -m dfss --url=open@sophgo.com:sophon-demo/SAM3/CV84X6_504.zip
    unzip CV84X6_504.zip -d ../models
    rm CV84X6_504.zip
