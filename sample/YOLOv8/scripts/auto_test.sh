...
{  
  ...
  python3 python/yolov8_$1.py --input datasets/coco/val2017 --bmodel models/$TARGET/$2 --dev_id $TPUID --conf_thresh 0.001 --nms_thresh 0.7 > python/log/$1_$2_debug.log 2>&1
  judge_ret $? "python3 python/yolov8_$1.py --input datasets/coco/val2017 --bmodel models/$TARGET/$2 --dev_id $TPUID --conf_thresh 0.001 --nms_thresh 0.7 > python/log/$1_$2_debug.log 2>&1"
  echo "------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
...
function eval_cpp()
{
  ...
  ./yolov8_$2.$1 --input=../../datasets/coco/val2017 --bmodel=../../models/$TARGET/$3 --conf_thresh=0.001 --nms_thresh=0.7  --dev_id $TPUID > log/$1_$2_$3_debug.log 2>&1
  judge_ret $? "./yolov8_$2.$1 --input=../../datasets/coco/val2017 --bmodel=../../models/$TARGET/$3 --conf_thresh=0.001 --nms_thresh=0.7  --dev_id $TPUID > log/$1_$2_$3_debug.log 2>&1"
  echo "-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
...
then
  ...
  then
    ...
    eval_python opencv yolov8s_fp32_1b.bmodel 0.44813313616005374
    eval_python opencv yolov8s_int8_1b.bmodel 0.4393198877927619
    eval_python opencv yolov8s_int8_4b.bmodel 0.4393198877927619
    eval_python bmcv yolov8s_fp32_1b.bmodel 0.44416400693187197
    eval_python bmcv yolov8s_int8_1b.bmodel 0.43542583423388764
    eval_python bmcv yolov8s_int8_4b.bmodel 0.43542583423388764
    eval_cpp pcie bmcv yolov8s_fp32_1b.bmodel 0.44826551684814087
    eval_cpp pcie bmcv yolov8s_int8_1b.bmodel 0.43991777410720123
    eval_cpp pcie bmcv yolov8s_int8_4b.bmodel 0.43991777410720123
  ...
  then
    ...
    eval_python opencv yolov8s_fp32_1b.bmodel 0.44813351120224043
    eval_python opencv yolov8s_fp16_1b.bmodel 0.4477609602014853
    eval_python opencv yolov8s_int8_1b.bmodel 0.4381778382602719  
    eval_python opencv yolov8s_int8_4b.bmodel 0.4381778382602719
    eval_python bmcv yolov8s_fp32_1b.bmodel 0.44421670206446445
    eval_python bmcv yolov8s_fp16_1b.bmodel 0.44397932055407885
    eval_python bmcv yolov8s_int8_1b.bmodel 0.4359141483100567 
    eval_python bmcv yolov8s_int8_4b.bmodel 0.4359141483100567
    eval_cpp pcie bmcv yolov8s_fp32_1b.bmodel 0.44830910475004754
    eval_cpp pcie bmcv yolov8s_fp16_1b.bmodel 0.4477752937215812
    eval_cpp pcie bmcv yolov8s_int8_1b.bmodel 0.4384638561190626
    eval_cpp pcie bmcv yolov8s_int8_4b.bmodel 0.4384638561190626
  fi
...
then
  ...
  then
    ...
    eval_python bmcv yolov8s_int8_1b.bmodel 0.43542583423388764
    eval_python bmcv yolov8s_int8_4b.bmodel 0.43542583423388764
    eval_cpp soc bmcv yolov8s_fp32_1b.bmodel 0.44826551684814087
    eval_cpp soc bmcv yolov8s_int8_1b.bmodel 0.43991777410720123
    eval_cpp soc bmcv yolov8s_int8_4b.bmodel 0.43991777410720123
  ...
  then
    ...
    eval_python bmcv yolov8s_int8_1b.bmodel 0.4359141483100567
    eval_python bmcv yolov8s_int8_4b.bmodel 0.4359141483100567
    eval_cpp soc bmcv yolov8s_fp32_1b.bmodel 0.44830910475004754
    eval_cpp soc bmcv yolov8s_fp16_1b.bmodel 0.4477752937215812
    eval_cpp soc bmcv yolov8s_int8_1b.bmodel 0.4384638561190626
    eval_cpp soc bmcv yolov8s_int8_4b.bmodel 0.4384638561190626
