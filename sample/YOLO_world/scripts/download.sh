...
then
    ...
    python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLO_world/models/onnx.tar.gz
    tar xvf onnx.tar.gz && rm onnx.tar.gz
    python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLO_world/models/text_projection_512_512.npy
    python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLO_world/models/bpe_simple_vocab_16e6.txt.gz
    popd
