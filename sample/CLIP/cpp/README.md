...
#CV84X6(SE13)上运行，模型路径换成models/CV84X6/下的同名cv84x6 bmodel即可
./clip_opencv.soc --image_path=../../datasets --text="a diagram, a dog, a car" --dev_id=0 --image_model="../../models/CV84X6/clip_image_vitb32_cv84x6_f16_1b.bmodel" --text_model="../../models/CV84X6/clip_text_vitb32_cv84x6_f16_1b.bmodel" --text_projection="../../models/text_projection_512_512.npy"
