...
#CV84X6(SE13)上运行，换成models/CV84X6/下的同名cv84x6 bmodel即可
python3 python/zeroshot_predict.py --image_path datasets --text "a diagram" "a dog" "a cat" --image_model models/CV84X6/clip_image_vitb32_cv84x6_f16_1b.bmodel --text_model models/CV84X6/clip_text_vitb32_cv84x6_f16_1b.bmodel --dev_id 0
