...
then
    if [ $download_bm1684x == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLOv8_plus_seg_fuse/BM1684X.tar.gz
...
then
    if [ $download_bm1688 == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLOv8_plus_seg_fuse/BM1688.tar.gz
...
then
    if [ $download_onnx == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLOv8_plus_seg_fuse/onnx.tar.gz
