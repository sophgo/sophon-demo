...
| SE13-64     | yoloworld_bmcv.py   | yoloworld_v2_fp16_1b.bmodel |    0.371 |    0.514 |
| SE13-64     | yoloworld_bmcv.py   | yoloworld_v2_int8_1b.bmodel |    0.366 |    0.514 |
> **测试说明**：
...
## 7. 性能测试
### 7.1 bmrt_test
使用bmrt_test测试模型的理论性能（SE7-32/SE13-64 SoC上，`bmrt_test`位于`/opt/sophon/libsophon-current/bin/bmrt_test`）：
```bash
...
|   SE13-64  | yoloworld_bmcv.py |yoloworld_v2_fp16_1b.bmodel |      2.91       |       2.65      |      20.37      |      5.10       |
|   SE13-64  | yoloworld_bmcv.py |yoloworld_v2_int8_1b.bmodel |      2.96       |       2.58      |      15.49      |      4.80       |
