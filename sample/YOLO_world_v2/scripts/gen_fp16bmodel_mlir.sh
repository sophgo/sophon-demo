#!/bin/bash
# ==============================================================================
# YOLO-World v2 FP16 BModel 编译 (TPU-MLIR)
# 在 TPU-MLIR 容器内运行(参考 ../../docs/Environment_Install_Guide.md): bash gen_fp16bmodel_mlir.sh [bm1684x]
# 产物: yoloworld_v2_fp16_1b.bmodel, clip_text_vitb32_${target}_f16_1b.bmodel
# ==============================================================================
...
function gen_fp16bmodel()
{
    model_deploy.py \
        ...
        --quantize F16 \
        --chip $target \
        --model yoloworld_v2_fp16_$1b.bmodel

    mv yoloworld_v2_fp16_$1b.bmodel $outdir/
    if test $target = "bm1688";then
        model_deploy.py \
            --mlir yoloworld_v2_$1b.mlir \
            --quantize F16 \
            --chip $target \
            --model yoloworld_v2_fp16_$1b_2core.bmodel \
            --num_core 2
        mv yoloworld_v2_fp16_$1b_2core.bmodel $outdir/
    fi
}
