...
from chatglm4 import ChatGLM4
from transformers import AutoTokenizer


token_path = './python/token_config'
bmodel_path = './models/BM1684X/glm4-9b_int4_1dev.bmodel'
dev_id = 0

st.title("ChatGlM4-9B")
...
if prompt := st.chat_input("请输入您的问题 "):
    ...
    client = ChatGLM4(st.session_state.handle, st.session_state.engine, st.session_state.tokenizer)
