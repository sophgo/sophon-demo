...
def cli():
    ...
    parser.add_argument("--bmodel_dir", type=str, default="../models/BM1690/", help="the path of bmodels; uses ../models/BM1690/ by default")

    parser.add_argument('--dev_id', type=int, default=0, help='dev id for sophgo tpu')
    parser.add_argument('--num_core', type=int, default=8, help='core num of your bmodel')
    ...
    pop_list = ["model_name", "bmodel_dir", "dev_id", "num_core"]
    for arg in pop_list:
        args.pop(arg)
