...
function gen_bmodel() {
    ...
    input_file="${onnx_dir}/${model_name}_input.npz"
    output_file="${onnx_dir}/${model_name}_output.npz"
...
for process_name in "${process_list[@]}"; do
    ...
    bmodel_file="all_quant_${model_name}_1690_f16.bmodel"
    ...
    pushd "$model_name"
    gen_bmodel
    echo "[Cmd] mv $bmodel_file ../../BM1690/"
    mv $bmodel_file ../../BM1690/
    popd
    rm -rf $bmodel_file
    popd
done
