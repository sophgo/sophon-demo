from StableDiffusionPipelineXL import StableDiffusionXLPipeline
...
if __name__ == "__main__":
    ...
    # prompts
    parser.add_argument("--prompt", type=str, default="An astronaut riding a green horse", help="prompt for this model")
    # negtive prompts
