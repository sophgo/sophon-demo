...
model_tool --combine $(ls -vr ${outdir}/ch_PP-OCRv3_det_fp16_*.bmodel) -o $outdir/ch_PP-OCRv3_det_fp16.bmodel
rm -r $outdir/ch_PP-OCRv3_det_fp16_*.bmodel
model_tool --combine $(ls -vr ${outdir}/ch_PP-OCRv3_cls_fp16_*.bmodel) -o $outdir/ch_PP-OCRv3_cls_fp16.bmodel
rm -r $outdir/ch_PP-OCRv3_cls_fp16_*.bmodel
model_tool --combine $(ls -vr ${outdir}/ch_PP-OCRv3_rec_fp16_*.bmodel) -o $outdir/ch_PP-OCRv3_rec_fp16.bmodel
...
if test $target = "bm1688";then
    ...
    echo "Combining bmodels..."
    model_tool --combine $(ls -vr $outdir/ch_PP-OCRv3_det_fp16_*b_*2core.bmodel) -o $outdir/ch_PP-OCRv3_det_fp16_2core.bmodel
    rm -r $outdir/ch_PP-OCRv3_det_fp16_*b_*.bmodel
    model_tool --combine $(ls -vr $outdir/ch_PP-OCRv3_cls_fp16_*b_*2core.bmodel) -o $outdir/ch_PP-OCRv3_cls_fp16_2core.bmodel
    rm -r $outdir/ch_PP-OCRv3_cls_fp16_*b_*.bmodel
    model_tool --combine $(ls -vr $outdir/ch_PP-OCRv3_rec_fp16_*b_*2core.bmodel) -o $outdir/ch_PP-OCRv3_rec_fp16_2core.bmodel
