...
function gen_int8bmodel()
{
    model_deploy.py \
        ...
        --quantize_table segformer_qtable \
        --model segformer.b0.512x1024.city.160k_int8_$1b.bmodel

    mv segformer.b0.512x1024.city.160k_int8_$1b.bmodel $outdir/
    if test $target = "bm1688";then
        model_deploy.py \
            ...
            --calibration_table segformer_cali_table \
            --quantize_table segformer_qtable \
            --model segformer.b0.512x1024.city.160k_int8_$1b_2core.bmodel \
            --num_core 2

        mv segformer.b0.512x1024.city.160k_int8_$1b_2core.bmodel $outdir/
    fi
}
