...
class PreProcess:
    def __init__(self, width, height, batch_size, img_dtype, input_scale=None):
        ...
        # print("input_scale: ", self.input_scale, flush=True)
    ...
    def __call__(self, img, handle, bmcv):
        ...
        bmcv.convert_to(resized_img_rgb, preprocessed_img, self.alpha_beta)
    ...
    def resize(self, img, handle, bmcv):
        ...
        if self.use_resize_padding:
            ...
            preprocess_fn = bmcv.vpp_crop_and_resize_padding \
                if self.use_vpp else bmcv.crop_and_resize_padding
    ...
    def norm_batch(self, resized_images, handle, bmcv):
        ...
        bmcv.convert_to(resized_images, preprocessed_imgs, self.alpha_beta)
