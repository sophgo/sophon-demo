...
```bash
./p2pnet_bmcv.pcie --input=../../datasets/ShanghaiTech/ShanghaiTech-Dataset/ShanghaiTech/part_A/test_data/images --bmodel=../../models/BM1684/p2pnet_bm1684_fp32_1b.bmodel --dev_id=0
```
