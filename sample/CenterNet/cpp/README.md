...
```bash
sage: centernet_bmcv.pcie [params] 
...
编译工具链：aarch64-linux-gnu，可参考《LIBSOPHON使用手册》手册中4.2 SOC MODE章节说明进行安装
...
mkdir build && cd build
rm -rf ./*
cmake -DTARGET_ARCH=arm -DSDK=${path_to_socsdk}/soc-sdk -DSAIL_PATH=${path_to_sail}/sophon-sail ..
make
```
...
2. `sophon-demo/simple/CenterNet/data/models/BM1684/centernet_fp32_1b.bmodel`
3. `sophon-demo/simple/CenterNet/data/models/BM1684/centernet_int8_4b.bmodel`
4. `sophon-demo/simple/CenterNet/data/ctdet_test.jpg`
5. `sophon-demo/simple/CenterNet/data/coco_classes.txt`
