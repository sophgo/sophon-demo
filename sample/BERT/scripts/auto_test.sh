...
function bmrt_test_benchmark(){
    ...
    if test $TARGET = "BM1684"; then
     ...
     bmrt_test_case BM1684/bert4torch_output_fp16_1b.bmodel
      ...
      # CV84X6当前固件不支持FP32，仅测FP16/INT8
      bmrt_test_case CV84X6/bert4torch_output_fp16_1b.bmodel
      bmrt_test_case CV84X6/bert4torch_output_fp16_8b.bmodel
      bmrt_test_case CV84X6/bert4torch_output_int8_1b.bmodel
      bmrt_test_case CV84X6/bert4torch_output_int8_8b.bmodel
    fi
    popd
}
