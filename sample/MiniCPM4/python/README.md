...
### 2.1 参数说明
minicpm4.py使用config/minicpm4.yaml配置文件进行参数配置。

minicpm4.yaml内容如下
```yaml
bmodel_path: ../models/BM1684X/minicpm4-8b_w4bf16_seq512_bm1684x_1dev_20250613_175044.bmodel   ## 用于推理的bmodel路径
...
```bash
cd python
python3 minicpm4.py --config ./config/minicpm4.yaml
```
