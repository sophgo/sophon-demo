...
usage() 
{
  echo "Usage: $0 [ -m MODE compile_mlir|pcie_build|pcie_test|soc_build|soc_test] [ -t TARGET BM1684|BM1684X|BM1684X2|BM1688|CV186X] [ -s SOCSDK] [-a SAIL] [ -d TPUID] [ -p PYTEST auto_test|pytest] [ -c fully|partly]" 1>&2
}
...
function bmrt_test_benchmark(){
    ...
    if test $TARGET = "BM1684X"; then
      ...
      bmrt_test_case BM1684X2/yolov8s_fp16_1b.bmodel
      bmrt_test_case BM1684X2/yolov8s_int8_1b.bmodel
      bmrt_test_case BM1684X2/yolov8s_int8_4b.bmodel
    elif test $TARGET = "BM1688"; then
...
function test_python()
{
  ...
  if test $3 = "datasets/imagenet_val_1k/img"; then
    echo "==================="
    ...
    echo "Evaluating..."
    python3 tools/eval_imagenet.py --gt_path datasets/imagenet_val_1k/label.txt --result_json results/$2_img_$1_python_result.json 2>&1 | tee log/$1_$2_eval.log
    echo "==================="
    echo "Comparing acc..."
    python3 tools/compare_acc.py --target=$TARGET --platform=${MODE%_*} --program=yolov8_$1.py --language=python --input=log/$1_$2_eval.log --bmodel=$2 2>&1
    judge_ret $? "python3 tools/compare_acc.py --target=$TARGET --platform=${MODE%_*} --program=yolov8_$1.py --language=python --input=log/$1_$2_eval.log --bmodel=$2"
    echo "==================="
  fi
}
...
function test_cpp()
{
  ...
  if test $4 = "../../datasets/imagenet_val_1k/img"; then
    echo "==================="
    echo "Comparing statis..."
    ...
    echo "Evaluating..."
    python3 ../../tools/eval_imagenet.py --gt_path ../../datasets/imagenet_val_1k/label.txt --result_json results/$3_img_$2_cpp_result.json 2>&1 | tee log/$1_$2_$3_eval.log
    echo "==================="
    echo "Comparing acc..."
    ...
    judge_ret $? "python3 ../../tools/compare_acc.py --target=$TARGET --platform=${MODE%_*} --program=yolov8_$2.$1 --language=cpp --input=log/$1_$2_$3_eval.log --bmodel=$3 2>&1"
    echo "==================="
  fi
  popd
}
...
then
  ...
  then
    download $TARGET
    test_python bmcv yolov8s_fp32_1b.bmodel datasets/imagenet_val_1k/img
    test_python bmcv yolov8s_fp16_1b.bmodel datasets/imagenet_val_1k/img
    test_python bmcv yolov8s_int8_1b.bmodel datasets/imagenet_val_1k/img
    test_python bmcv yolov8s_int8_4b.bmodel datasets/imagenet_val_1k/img
    test_cpp pcie bmcv yolov8s_fp32_1b.bmodel ../../datasets/imagenet_val_1k/img
    test_cpp pcie bmcv yolov8s_fp16_1b.bmodel ../../datasets/imagenet_val_1k/img
    test_cpp pcie bmcv yolov8s_int8_1b.bmodel ../../datasets/imagenet_val_1k/img
    test_cpp pcie bmcv yolov8s_int8_4b.bmodel ../../datasets/imagenet_val_1k/img
  fi
...
then
  ...
  then
    ...
    test_python bmcv yolov8s_int8_1b.bmodel datasets/imagenet_val_1k/img
    test_python bmcv yolov8s_int8_4b.bmodel datasets/imagenet_val_1k/img
    test_cpp soc bmcv yolov8s_fp32_1b.bmodel ../../datasets/imagenet_val_1k/img
    test_cpp soc bmcv yolov8s_fp16_1b.bmodel ../../datasets/imagenet_val_1k/img
    test_cpp soc bmcv yolov8s_int8_1b.bmodel ../../datasets/imagenet_val_1k/img
    test_cpp soc bmcv yolov8s_int8_4b.bmodel ../../datasets/imagenet_val_1k/img
