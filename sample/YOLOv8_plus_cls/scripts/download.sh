...
then
    mkdir ../datasets
    pushd ../datasets
    python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLOv8_plus_cls/imagenet_val_1k.tar.gz
    tar xvf imagenet_val_1k.tar.gz && rm imagenet_val_1k.tar.gz
    python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLOv8_plus_cls/cali_data.tar.gz
...
then
    if [ $download_cv84x6 == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLOv8_plus_cls/CV84X6.tar.gz
...
then
    if [ $download_cv186x == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLOv8_plus_cls/CV186X.tar.gz
...
then
    if [ $download_onnx == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLOv8_plus_cls/onnx.tar.gz
