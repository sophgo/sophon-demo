...
Usage: yolov8_bmcv.pcie [params] 
        ...
        --bmodel (value:../../models/BM1684X/yolov8s_fp32_1b.bmodel)
                bmodel file path
        --dev_id (value:0)
                TPU device id
        --help (value:true)
                print help information.
        --input (value:../../datasets/cali_data)
...
```bash
./yolov8_bmcv.pcie --input=../../datasets/cali_data --bmodel=../../models/BM1684X/yolov8s_fp32_1b.bmodel --dev_id=0
```
测试结束后，预测的结果保存在`results/yolov8s_fp32_1b.bmodel_cali_data_bmcv_cpp_result.json`下，同时会打印预测结果、推理时间等信息。