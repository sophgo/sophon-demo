...
def argsparser():
    ...
    parser.add_argument('--result_json', type=str, default='./results/yolo26s_fp16_1b.bmodel_val2017_1000_bmcv_python_result.json', help='path of result json')
...
def convert_to_coco_seg(json_file, cocoGt):
    temp_json = []
    coco91class = coco80_to_coco91_class()
    images_list = cocoGt.dataset["images"]
    with open(json_file, 'r') as f:
...
def main(args):
    ...
    if args.ann_type == 'segm':
        convert_to_coco_seg(args.result_json, cocoGt)
