...
then
    if [ $download_bm1684x == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLO26_seg/BM1684X.tar.gz
...
then
    if [ $download_bm1684x2 == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLO26_seg/BM1684X2.tar.gz
...
then
    if [ $download_bm1688 == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLO26_seg/BM1688.tar.gz
...
then
    if [ $download_cv186x == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLO26_seg/CV186X.tar.gz
...
then
    if [ $download_onnx == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLO26_seg/onnx.tar.gz
