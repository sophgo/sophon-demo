...
└── （config.yaml/tokens.json/am.mvn/seg_dict 与BM1684X共用，见model/目录）
```
...
| SE13-64    | seaco_paraformer.py     | encoder/decoder/predictor BF16     | 见测试说明6 | 见测试说明6 |
| SE13-64    | seaco_paraformer_bmrt.soc | encoder/decoder/predictor BF16   | 见测试说明6 | 见测试说明6 |
...
|   SE13-64   | seaco_paraformer.py       | encoder/decoder/predictor BF16        |  6.886       |  0.105     |  0.029     |  8.325   | 1.841 |
|   SE13-64   | seaco_paraformer_bmrt.soc | encoder/decoder/predictor BF16        |  6.505       |  0.105     |  0.028     |  8.025   | 1.774 |
