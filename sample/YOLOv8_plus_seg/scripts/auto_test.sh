...
function bmrt_test_benchmark(){
    ...
    if test $TARGET = "BM1684X"; then
      ...
      bmrt_test_case CV84X6/yolov8s_fp32_1b.bmodel
      ...
      bmrt_test_case CV84X6/yolov9c_fp32_1b.bmodel
      bmrt_test_case CV84X6/yolov9c_fp16_1b.bmodel
      bmrt_test_case CV84X6/yolov9c_int8_1b.bmodel
      bmrt_test_case CV84X6/yolov9c_int8_4b.bmodel
    elif test $TARGET = "BM1688"; then
