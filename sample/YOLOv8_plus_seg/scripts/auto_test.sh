...
function bmrt_test_benchmark(){
    ...
    if test $TARGET = "BM1684X"; then
      ...
      bmrt_test_case BM1684X2/yolov8s_fp32_1b.bmodel
      ...
      bmrt_test_case BM1684X2/yolov9c_fp32_1b.bmodel
      bmrt_test_case BM1684X2/yolov9c_fp16_1b.bmodel
      bmrt_test_case BM1684X2/yolov9c_int8_1b.bmodel
      bmrt_test_case BM1684X2/yolov9c_int8_4b.bmodel
    elif test $TARGET = "BM1688"; then
...
then
  ...
  then
    for model in yolov8s yolov9c; do
