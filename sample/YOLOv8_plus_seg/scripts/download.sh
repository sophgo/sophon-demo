...
then
    if [ $download_bm1684x2 == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLOv8_plus_seg/BM1684X2.tar.gz
...
then
    if [ $download_bm1688 == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLOv8_plus_seg/BM1688.tar.gz
...
then
    if [ $download_onnx == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/YOLOv8_plus_seg/onnx.tar.gz
