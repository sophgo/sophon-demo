...
class PPYOLO:
    ...
    def __call__(self, bmimg_list):
        ...
        start_time = time.time()
        results = self.postprocess(outputs, ori_size_list, self.net_h, self.net_w)
...
def main(args):
    ...
    preprocess_time = ppyolov3.preprocess_time / cn
    inference_time = ppyolov3.inference_time / cn
    postprocess_time = ppyolov3.postprocess_time / cn
...
def argsparser():
    ...
    parser.add_argument('--bmodel', type=str, default='../models/BM1684/ppyolov3s_v6.1_3output_fp32_1b.bmodel', help='path of bmodel')
