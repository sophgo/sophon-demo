...
def argsparser():
    ...
    parser.add_argument('--pred_path', type=str, default='../python/results', help='path of result folder')
    ...
    parser.add_argument('--img_module', type=str, default='bmcv', help='image processing module, choose from bmcv and opencv')
...
def main(args):
    ...
    args.pred_path = args.pred_path + f'/resnet_{args.data_type}_b{args.batch_size}.bmodel_img_{args.img_module}_python_result.txt'
