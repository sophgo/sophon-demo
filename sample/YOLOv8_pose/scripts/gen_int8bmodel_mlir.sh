...
function gen_mlir()
{
   model_transform.py \
        ...
        --model_def ../models/onnx/yolov8s-pose.onnx \
        ...
        --test_result yolov8s-pose_top_outputs.npz \
        --mlir yolov8s-pose_$1b.mlir
}

function gen_cali_table()
{
    run_calibration.py yolov8s-pose_$1b.mlir \
        --dataset ../datasets/coco128/ \
        --input_num 32 \
        -o yolov8s-pose_cali_table
}

function gen_qtable()
{
    fp_forward.py yolov8s-pose_$1b.mlir \
        --quantize INT8 \
...
function gen_int8bmodel()
{
    model_deploy.py \
        ...
        --quantize_table yolov8-pose_qtable \
        --test_input yolov8s-pose_in_f32.npz \
        --test_reference yolov8s-pose_top_outputs.npz \
        --model yolov8s-pose_int8_$1b.bmodel

    mv yolov8s-pose_int8_$1b.bmodel $outdir/
    if test $target = "bm1688";then
        model_deploy.py \
            --mlir yolov8s-pose_$1b.mlir \
            --quantize INT8 \
            --chip $target \
            --model yolov8s-pose_int8_$1b_2core.bmodel \
            --calibration_table yolov8s-pose_cali_table \
            --num_core 2 \
            --quantize_table yolov8-pose_qtable \
            --test_input yolov8s-pose_in_f32.npz \
        ...
        mv yolov8s-pose_int8_$1b_2core.bmodel $outdir/
    fi
}
