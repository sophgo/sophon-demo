...
## 1. 简介
​YOLOv8是YOLO系列的的一个重大更新版本，它抛弃了以往的YOLO系类模型使用的Anchor-Base，采用了Anchor-Free的思想。YOLOv8建立在YOLO系列成功的基础上，通过对网络结构的改造，进一步提升其性能和灵活性。本例程对[​YOLOv8官方开源仓库](https://github.com/ultralytics/ultralytics)的模型和算法进行移植，使之能在SOPHON BM1684/BM1684X/BM1684X2/BM1688/CV186X上进行推理测试。
...
├── BM1684X2
│   ├── yolov8s-pose_fp32_1b.bmodel   # 使用TPU-MLIR编译，用于BM1684X2的FP32 BModel，batch_size=1
│   ├── yolov8s-pose_fp16_1b.bmodel   # 使用TPU-MLIR编译，用于BM1684X2的FP16 BModel，batch_size=1
│   ├── yolov8s-pose_int8_1b.bmodel   # 使用TPU-MLIR编译，用于BM1684X2的INT8 BModel，batch_size=1
│   └── yolov8s-pose_int8_4b.bmodel   # 使用TPU-MLIR编译，用于BM1684X2的INT8 BModel，batch_size=4
│── torch
...
| SE13-64      | yolov8_opencv.py | yolov8s-pose_fp32_1b.bmodel        |      0.575      |    0.801   |
| SE13-64      | yolov8_opencv.py | yolov8s-pose_fp16_1b.bmodel        |      0.574      |    0.802   |
| SE13-64      | yolov8_opencv.py | yolov8s-pose_int8_1b.bmodel        |      0.554      |    0.801   |
| SE13-64      | yolov8_opencv.py | yolov8s-pose_int8_4b.bmodel        |      0.554      |    0.801   |
| SE13-64      | yolov8_bmcv.py   | yolov8s-pose_fp32_1b.bmodel        |      0.574      |    0.801   |
| SE13-64      | yolov8_bmcv.py   | yolov8s-pose_fp16_1b.bmodel        |      0.575      |    0.802   |
| SE13-64      | yolov8_bmcv.py   | yolov8s-pose_int8_1b.bmodel        |      0.553      |    0.800   |
| SE13-64      | yolov8_bmcv.py   | yolov8s-pose_int8_4b.bmodel        |      0.553      |    0.800   |
| SE13-64      | yolov8_bmcv.soc  | yolov8s-pose_fp32_1b.bmodel        |      0.574      |    0.793   |
| SE13-64      | yolov8_bmcv.soc  | yolov8s-pose_fp16_1b.bmodel        |      0.575      |    0.802   |
| SE13-64      | yolov8_bmcv.soc  | yolov8s-pose_int8_1b.bmodel        |      0.553      |    0.800   |
| SE13-64      | yolov8_bmcv.soc  | yolov8s-pose_int8_4b.bmodel        |      0.553      |    0.800   |
...
|   SE13-64   | BM1684X2/yolov8s-pose_fp32_1b.bmodel    |         109.40  |
|   SE13-64   | BM1684X2/yolov8s-pose_fp16_1b.bmodel    |          11.34  |
|   SE13-64   | BM1684X2/yolov8s-pose_int8_1b.bmodel    |           5.65  |
|   SE13-64   | BM1684X2/yolov8s-pose_int8_4b.bmodel    |           5.44  |
