...
def argsparser():
    ...
    parser.add_argument('--result_json', type=str, default="../python/results/yolact_bm1684x_fp32_1b.bmodel_val2017_1000_bmcv_python_result.json", help='path of result json')
