...
def argsparser():
    ...
    parser.add_argument('--result_json', type=str, default='../python/results/mobilenetv4_conv_medium_fp32_1b.bmodel_img_opencv_python_result.json', help='path of result json')
