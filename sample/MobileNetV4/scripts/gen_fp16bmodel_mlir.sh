...
function gen_fp16bmodel()
{
    model_deploy.py \
        ...
        --quantize F16 \
        --chip $target \
        --model mobilenetv4_conv_medium_fp16_$1b.bmodel

    mv mobilenetv4_conv_medium_fp16_$1b.bmodel $outdir/
    if test $target = "bm1688";then
        model_deploy.py \
            --mlir mobilenetv4_conv_medium_$1b.mlir \
            --quantize F16 \
            --chip $target \
            --model mobilenetv4_conv_medium_fp16_$1b_2core.bmodel \
            --num_core 2
        mv mobilenetv4_conv_medium_fp16_$1b_2core.bmodel $outdir/
    fi
}
