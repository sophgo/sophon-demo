...
function bmrt_test_benchmark(){
    ...
    for model in ppyoloe; do
      if test $TARGET = "BM1684"; then
        bmrt_test_case ${TARGET}/${model}_fp32_1b.bmodel
      else
...
function test_python()
{
  ...
  python3 python/ppyoloe_$1.py --input $3 --bmodel models/$TARGET/$2 --dev_id $TPUID > log/$1_$2_python_test.log 2>&1
  ...
  if test $3 = "datasets/coco/val2017_1000"; then
    ...
    python3 tools/compare_statis.py --target=$TARGET --platform=${MODE%_*} --program=ppyoloe_$1.py --language=python --input=log/$1_$2_python_test.log --bmodel=$2 2>&1
    judge_ret $? "python3 tools/compare_statis.py --target=$TARGET --platform=${MODE%_*} --program=ppyoloe_$1.py --language=python --input=log/$1_$2_python_test.log --bmodel=$2"
    echo "==================="
  fi
}
...
{ 
  ...
  echo "==================="
  echo "Comparing acc..."
  python3 tools/compare_acc.py --target=$TARGET --platform=${MODE%_*} --program=ppyoloe_$1.py --language=python --input=python/log/$1_$2_eval.log --bmodel=$2 2>&1
  judge_ret $? "python3 tools/compare_acc.py --target=$TARGET --platform=${MODE%_*} --program=ppyoloe_$1.py --language=python --input=python/log/$1_$2_eval.log --bmodel=$2"
  echo "==================="
...
function test_cpp()
{
  ...
  ./ppyoloe_$2.$1 --input=$4 --bmodel=../../models/$TARGET/$3 --dev_id=$TPUID > log/$1_$2_$3_cpp_test.log 2>&1
  ...
  if test $4 = "../../datasets/coco/val2017_1000"; then
    echo "==================="
    echo "Comparing statis..."
    python3 ../../tools/compare_statis.py --target=$TARGET --platform=${MODE%_*} --program=ppyoloe_$2.$1 --language=cpp --input=log/$1_$2_$3_cpp_test.log --bmodel=$3 2>&1
    judge_ret $? "python3 ../../tools/compare_statis.py --target=$TARGET --platform=${MODE%_*} --program=ppyoloe_$2.$1 --language=cpp --input=log/$1_$2_$3_cpp_test.log --bmodel=$3"
    echo "==================="
  fi
  popd
}
...
function eval_cpp()
{
  ...
  echo "==================="
  echo "Comparing acc..."
  python3 ../../tools/compare_acc.py --target=$TARGET --platform=${MODE%_*} --program=ppyoloe_$2.$1 --language=cpp --input=log/$1_$2_$3_eval.log --bmodel=$3 2>&1
  judge_ret $? "python3 ../../tools/compare_acc.py --target=$TARGET --platform=${MODE%_*} --program=ppyoloe_$2.$1 --language=cpp --input=log/$1_$2_$3_eval.log --bmodel=$3"
  echo "==================="
  popd
  echo -e "########################\nCase End: eval cpp\n########################\n"
}
...
then
  ...
  then
    test_python bmcv ppyoloes_int8_1b.bmodel datasets/test_car_person_1080P.mp4
    test_cpp pcie bmcv ppyoloes_int8_1b.bmodel ../../datasets/test_car_person_1080P.mp4
    eval_python bmcv ppyoloes_int8_1b.bmodel
    eval_cpp pcie bmcv ppyoloes_int8_1b.bmodel
  fi
...
then
  ...
  then
    test_python bmcv ppyoloes_int8_1b.bmodel datasets/test_car_person_1080P.mp4
    test_cpp soc bmcv ppyoloes_int8_1b.bmodel ../../datasets/test_car_person_1080P.mp4

    test_python bmcv ppyoloes_int8_1b.bmodel datasets/coco/val2017_1000
    test_cpp soc bmcv ppyoloes_int8_1b.bmodel ../../datasets/coco/val2017_1000

    eval_python bmcv ppyoloes_int8_1b.bmodel
    eval_cpp soc bmcv ppyoloes_int8_1b.bmodel
  fi
fi
