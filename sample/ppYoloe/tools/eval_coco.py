...
def argsparser():
    ...
    parser.add_argument('--result_json', type=str, default='project/sophon-demo/sample/ppyoloe/python/results/ppyoloe_s_fp32_1b.bmodel__opencv_python_result.json', help='path of result json')
