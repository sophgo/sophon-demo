...
if [ ! -d "../datasets" ]; 
then
    python3 -m dfss --url=open@sophgo.com:sophon-demo/SlowFast/datasets_1012/datasets.zip
...
then
    mkdir ../models
    python3 -m dfss --url=open@sophgo.com:sophon-demo/SlowFast/models_1012/BM1684X.zip
    ...
    #rm CV186X.zip
    python3 -m dfss --url=open@sophgo.com:sophon-demo/SlowFast/models_1012/onnx.zip
