...
## 1. 简介
P2PNet是腾讯优图实验室提出的点对点网络（Point-to-Point Network，P2PNet），业界首创直接预测人头中心点的人群计数新范式，能够同时实现人群个体定位和人群计数，该算法在 2020 年 12 月份刷新 NWPU 榜单。本例程对[P2PNet官方开源仓库](https://github.com/TencentYoutuResearch/CrowdCounting-P2PNet)的模型和算法进行移植，使之能在SOPHON BM1684|BM1684X|BM1688|CV186X|CV84X6上进行推理测试。

**数据集**: (https://www.datafountain.cn/datasets/5670)

## 2. 特性
* 支持BM1684X(x86 PCIe、SoC、riscv PCIe)、BM1684(x86 PCIe、SoC、arm PCIe)、BM1688(SoC)、CV186X(SoC)和CV84X6(SoC)
* 支持FP32、FP16(BM1684X/BM1688/CV186X/CV84X6)、INT8模型编译和推理
* 支持基于BMCV预处理的C++推理
...
├── CV84X6
│   ├── p2pnet_cv84x6_fp16_1b.bmodel  # 使用TPU-MLIR编译，用于CV84X6的FP16 BModel，batch_size=1
│   ├── p2pnet_cv84x6_int8_1b.bmodel  # 使用TPU-MLIR编译，用于CV84X6的INT8 BModel，batch_size=1
│   └── p2pnet_cv84x6_int8_4b.bmodel  # 使用TPU-MLIR编译，用于CV84X6的INT8 BModel，batch_size=4
└── onnx
...
​本例程在`scripts`目录下提供了TPU-MLIR编译FP16 BModel的脚本，请注意修改`gen_fp16bmodel_mlir.sh`中的onnx模型路径、生成模型目录和输入大小shapes等参数，并在执行时指定BModel运行的目标平台（支持BM1684|BM1684X|BM1688|CV186X|CV84X6），如：
...
| SRM1-20      | p2pnet_opencv.py   | p2pnet_bm1684x_fp32_1b.bmodel |  18.35 | 29.12 |
...
| SE13-64      | p2pnet_opencv.py   | p2pnet_cv84x6_fp16_1b.bmodel |  18.31 | 29.09 |
| SE13-64      | p2pnet_opencv.py   | p2pnet_cv84x6_int8_1b.bmodel |  18.59 | 29.72 |
| SE13-64      | p2pnet_opencv.py   | p2pnet_cv84x6_int8_4b.bmodel |  18.59 | 29.72 |
| SE13-64      | p2pnet_bmcv.py     | p2pnet_cv84x6_fp16_1b.bmodel |  20.16 | 30.42 |
| SE13-64      | p2pnet_bmcv.py     | p2pnet_cv84x6_int8_1b.bmodel |  20.41 | 30.68 |
| SE13-64      | p2pnet_bmcv.py     | p2pnet_cv84x6_int8_4b.bmodel |  20.41 | 30.68 |
| SE13-64      | p2pnet_bmcv.soc    | p2pnet_cv84x6_fp16_1b.bmodel |  18.06 | 28.66 |
| SE13-64      | p2pnet_bmcv.soc    | p2pnet_cv84x6_int8_1b.bmodel |  18.18 | 28.67 |
| SE13-64      | p2pnet_bmcv.soc    | p2pnet_cv84x6_int8_4b.bmodel |  18.18 | 28.67 |
...
> 4.CV84X6(SE13)上C++例程读取TPU输出使用`bm_memcpy_d2s`而非`bm_mem_mmap_device_mem`：SE13的mmap+invalidate读回方式会非确定性地读到脏缓存数据，导致结果在两次运行间漂移（fp16_1b MAE漂移到50+，int8_1b漂移到70+），d2s读回结果正确且耗时无可测差别；
...
|   SE13-64  | CV84X6/p2pnet_cv84x6_fp16_1b.bmodel 	 | 36.25              |
|   SE13-64  | CV84X6/p2pnet_cv84x6_int8_1b.bmodel 	 | 18.49              |
|   SE13-64  | CV84X6/p2pnet_cv84x6_int8_4b.bmodel 	 | 18.09              |
...
| SRM1-20|  p2pnet_bmcv.py   |   p2pnet_bm1684x_fp16_1b.bmodel   |      58.35      |      6.82       |      26.55      |      6.18       |
...
| SE13-64 | p2pnet_opencv.py | p2pnet_cv84x6_fp16_1b.bmodel  | 12.72      | 43.98         | 37.81        | 5.84      |
| SE13-64 | p2pnet_opencv.py | p2pnet_cv84x6_int8_1b.bmodel  | 12.74      | 44.06         | 19.99        | 5.83      |
| SE13-64 | p2pnet_opencv.py | p2pnet_cv84x6_int8_4b.bmodel  | 12.74      | 44.06         | 19.99        | 5.83      |
| SE13-64 | p2pnet_bmcv.py   | p2pnet_cv84x6_fp16_1b.bmodel  | 3.15       | 3.24          | 36.69        | 5.82      |
| SE13-64 | p2pnet_bmcv.py   | p2pnet_cv84x6_int8_1b.bmodel  | 3.10       | 3.24          | 18.88        | 5.77      |
| SE13-64 | p2pnet_bmcv.py   | p2pnet_cv84x6_int8_4b.bmodel  | 3.10       | 3.24          | 18.88        | 5.77      |
| SE13-64 | p2pnet_bmcv.soc  | p2pnet_cv84x6_fp16_1b.bmodel  | 4.340      | 1.336         | 36.151       | 1.773     |
| SE13-64 | p2pnet_bmcv.soc  | p2pnet_cv84x6_int8_1b.bmodel  | 4.316      | 1.335         | 18.352       | 1.773     |
| SE13-64 | p2pnet_bmcv.soc  | p2pnet_cv84x6_int8_4b.bmodel  | 4.279      | 1.109         | 18.094       | 1.757     |
