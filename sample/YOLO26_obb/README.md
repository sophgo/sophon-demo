...
## 1. 简介
​YOLO26_obb对[​YOLO26官方开源仓库](https://github.com/ultralytics/ultralytics)v8.4.14的yolo26s-obb模型和算法进行移植，使之能在SOPHON BM1684X/CV84X6/BM1688/CV186X上进行推理测试。

## 2. 特性
* 支持BM1688/CV186X(SoC)、BM1684X(x86 PCIe、SoC)和CV84X6(SoC)
* 支持FP32、FP16(BM1684X/CV84X6/BM1688/CV186X)模型编译和推理
* 支持基于BMCV预处理的C++推理
...
> 2. 在搭载了相同TPU和SOPHONSDK的PCIe或SoC平台上，相同程序的精度一致，SE7系列对应BM1684X，SE9系列中，SE9-16对应BM1688，SE9-8对应CV186X；SE13系列对应CV84X6，其TPU与BM1684X(SE7系列)相同，模型推理精度一致
...
| SE13-64          | CV84X6/yolo26s_fp16_1b.bmodel     |          30.26  |
| SE13-64          | CV84X6/yolo26s_int8_1b.bmodel    |          19.98  |
...
|   SE13-64    | yolo26_opencv.py  |      yolo26s_fp16_1b.bmodel       |     110.21      |      67.20      |      33.39      |      1.00                          |
|   SE13-64    | yolo26_opencv.py  |      yolo26s_int8_1b.bmodel       |     110.11      |      67.68      |      23.11      |      1.01                          |
|   SE13-64    |  yolo26_bmcv.py   |      yolo26s_fp16_1b.bmodel       |      19.17      |      18.90      |      29.94      |      0.86                          |
|   SE13-64    |  yolo26_bmcv.py   |      yolo26s_int8_1b.bmodel       |      20.04      |      18.93      |      19.67      |      0.85                          |
|   SE13-64    |  yolo26_bmcv.soc  |      yolo26s_fp16_1b.bmodel       |      18.43      |      17.39      |      29.54      |      0.068                         |
|   SE13-64    |  yolo26_bmcv.soc  |      yolo26s_int8_1b.bmodel       |      18.55      |      17.40      |      19.27      |      0.066                         |
