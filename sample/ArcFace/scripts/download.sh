...
then
    if [ $download_bm1684x == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/ArcFace/models/BM1684X.tar.gz
...
then
    if [ $download_bm1684x2 == 1 ]; then
        python3 -m dfss --url=open@sophgo.com:sophon-demo/ArcFace/models/BM1684X2.tar.gz
