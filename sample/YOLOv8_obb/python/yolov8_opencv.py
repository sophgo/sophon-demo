...
from postprocess_torch import PostProcess
from utils import DOTA_CLASSES, COLORS
...
def argsparser():
    ...
    parser.add_argument('--bmodel', type=str, default='../models/BM1684X/yolov8s-obb_fp16_1b.bmodel', help='path of bmodel')
