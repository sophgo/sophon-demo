...
class ByteTracker(object):
    def __init__(self, min_box_area, track_thresh, track_buffer, match_thresh):

        self.min_box_area = min_box_area
        self.track_thresh = track_thresh
        self.tracker = BYTETracker(
            track_thresh, track_buffer, match_thresh, frame_rate=30)
    ...
    def _tracker_update(self, bbox, scores, image):
        ...
        self.frame_id = self.tracker.frame_id
        return results
