...
then
  ...
  then
    ...
    eval_python opencv yolov5s_v6.1_3output_fp32_1b.bmodel  0.516
    eval_python opencv yolov5s_v6.1_3output_fp16_1b.bmodel  0.516
    eval_python opencv yolov5s_v6.1_3output_int8_1b.bmodel  0.485
    eval_python opencv yolov5s_v6.1_3output_int8_4b.bmodel  0.485
    eval_cpp soc opencv yolov5s_v6.1_3output_fp32_1b.bmodel 0.524
    eval_cpp soc opencv yolov5s_v6.1_3output_fp16_1b.bmodel 0.524
    eval_cpp soc opencv yolov5s_v6.1_3output_int8_1b.bmodel 0.500
    eval_cpp soc opencv yolov5s_v6.1_3output_int8_4b.bmodel 0.500
    eval_cpp soc eigen yolov5s_v6.1_3output_fp32_1b.bmodel  0.524
    eval_cpp soc eigen yolov5s_v6.1_3output_fp16_1b.bmodel  0.524
    eval_cpp soc eigen yolov5s_v6.1_3output_int8_1b.bmodel  0.500
    eval_cpp soc eigen yolov5s_v6.1_3output_int8_4b.bmodel  0.500
  fi
fi
