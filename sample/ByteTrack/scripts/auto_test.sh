...
function run_example_cpp() {
  ../cpp/bytetrack_bmcv/bytetrack-bmcv-cpp image ../data/MOT15/ADL-Rundle-6/img1 ../data/models/$2/bytetrack_s_fp32_1b.bmodel 10 0.1 0.7 ../cpp/bytetrack_bmcv/results $3
...
function run_example_py() {
  ...
  python3 ../python/bytetrack_bmcv.py \
    ...
    --bmodel=../data/models/$2/bytetrack_s_fp32_1b.bmodel \
