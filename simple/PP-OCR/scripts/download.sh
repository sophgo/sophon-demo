...
python3 -m dfn --url http://219.142.246.77:65000/sharing/sny6uBdN9
tar -xvf ch_PP-OCRv2_det_infer.tar -C ../data/models
rm ch_PP-OCRv2_det_infer.tar

# ch_PP-OCRv2_rec_infer 
python3 -m dfn --url http://219.142.246.77:65000/sharing/fbIAcI119
tar -xvf ch_PP-OCRv2_rec_infer.tar -C ../data/models
rm ch_PP-OCRv2_rec_infer.tar 

# ch_ppocr_mobile_v2.0_cls_infer
python3 -m dfn --url http://219.142.246.77:65000/sharing/IxA5hKuLf
...
# # BM1684X
python3 -m dfn --url http://219.142.246.77:65000/sharing/PzQcH4eG6
